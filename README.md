...
**1. Strategy A (Forecast-Guided Allocation Weighting):** Capital target sizing favored tickers displaying the highest relative upward slope velocity inside the out-of-sample calculation bounds.

**2. Strategy B (Volatility-Aware Inverse-Sizing):** Asset weights were scaled inversely proportional to their estimated log conditional volatility boundaries to limit severe portfolio drawdown profiles.
